...
return new class extends Migration
{
    ...
    private function indexes(): array
    {
        return [
            ...
            'legal_signature_cleanup_debts_due_idx' => "CREATE INDEX CONCURRENTLY legal_signature_cleanup_debts_due_idx ON legal_archive_file_cleanup_debts USING btree (next_attempt_at, id) WHERE resolved_at IS NULL AND dead_lettered_at IS NULL AND reason = 'signature_registration_failed' AND storage_version_id IS NOT NULL",
