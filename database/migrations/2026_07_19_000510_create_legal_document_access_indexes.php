...
return new class extends Migration
{
    ...
    {
        return [
            'legal_document_parties_ownership_unique' => $this->descriptor('legal_document_parties', true, ['id', 'document_id', 'organization_id'], null, 'CREATE UNIQUE INDEX CONCURRENTLY legal_document_parties_ownership_unique ON legal_document_parties (id, document_id, organization_id)'),
            ...
            'legal_document_access_active_subject_unique' => $this->descriptor('legal_document_access_grants', true, ['organization_id', 'document_id', 'subject_organization_id', 'COALESCE(subject_user_id, 0::bigint)'], 'revoked_at IS NULL', 'CREATE UNIQUE INDEX CONCURRENTLY legal_document_access_active_subject_unique ON legal_document_access_grants (organization_id, document_id, subject_organization_id, COALESCE(subject_user_id, 0::bigint)) WHERE revoked_at IS NULL'),
