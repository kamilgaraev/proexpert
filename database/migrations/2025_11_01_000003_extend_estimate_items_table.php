...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('estimate_items', function (Blueprint $table) {
            DB::statement('CREATE INDEX estimate_items_applied_coefficients_gin_idx ON estimate_items USING GIN(applied_coefficients)');
            DB::statement('CREATE INDEX estimate_items_resource_calculation_gin_idx ON estimate_items USING GIN(resource_calculation)');
            DB::statement('CREATE INDEX estimate_items_custom_resources_gin_idx ON estimate_items USING GIN(custom_resources)');
        });
    }
