...
return [
    ...
    'errors' => [
        ...
        'qr_employee_not_linked' => 'Профиль сотрудника не связан с учетной записью.',
        'qr_employee_inactive' => 'Сотрудник не активен на выбранную дату.',
        'qr_project_unavailable' => 'Объект недоступен для подтверждения явки.',
        'qr_token_expired' => 'Срок действия QR-кода истек.',
        'qr_token_already_used' => 'Этот QR-код уже использован.',
        'qr_token_invalid' => 'QR-код не найден или больше не действует.',
        'qr_scan_forbidden' => 'Недостаточно прав для подтверждения явки.',
        'self_attendance_forbidden' => 'Недостаточно прав для самоотметки явки.',
        'attendance_already_confirmed' => 'Явка на выбранную дату уже подтверждена.',
    ],
    'employee_statuses' => [
        'active' => 'Работает',
        'dismissed' => 'Уволен',
    ...
    'presence_sources' => [
        ...
        'qr_scan' => 'QR-подтверждение',
        'self_attendance' => 'Самоотметка',
    ...
    'attendance' => [
        ...
        'qr_status_rejected' => 'Явка не подтверждена.',
        'qr_source_label' => 'QR-подтверждение',
        'self_source_label' => 'Самоотметка',
    ],
    'actions' => [
    ...
    'validation' => [
        'date_range_invalid' => 'Дата окончания должна быть не раньше даты начала.',
