...
return [
    ...
    'transfer_to_contractor_default_reason' => 'Передача материалов подрядчику «:contractor»',
    'received_from_customer_reason' => 'Получено от заказчика «:organization»',
    'contractor_warehouse_name' => 'Склад подрядчика: :contractor',
    'contractor_warehouse_description' => 'Автоматически созданный склад подрядчика «:contractor»',
    'main_warehouse_name' => 'Основной склад',
