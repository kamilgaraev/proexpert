...
return [
    ...
    'errors' => [
        'forbidden' => 'Недостаточно прав для этого действия по приёмке.',
        'quantity_source_changed' => 'Объём или единица выполненной работы изменились. Проверьте предъявленные объёмы перед приёмкой.',
        'executive_evidence_invalid' => 'Укажите согласованную актуальную редакцию документа ИД из комплекта этого проекта.',
        'required_checklist_incomplete' => 'Нельзя принять зону: обязательный пункт чек-листа не подтверждён.',
