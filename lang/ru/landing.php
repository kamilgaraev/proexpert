...
return [
    ...
    'packages' => [
        ...
        'trial_started' => 'Пробный доступ к пакету подключен на 72 часа.',
        'trial_already_used' => 'Пробный доступ к этому пакету уже использован.',
        'trial_package_not_found' => 'Выбранный пакет не найден.',
        'trial_start_error' => 'Не удалось подключить пробный доступ к пакету.',
