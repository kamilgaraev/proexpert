...
return [
    ...
    'team_member_not_found' => 'Сотрудник не найден в этой компании.',
    'team_access_protected' => 'Нельзя отключить собственный доступ или доступ владельца компании.',
    'team_account_inactive' => 'Учётная запись сотрудника отключена. Для восстановления обратитесь в поддержку.',
    'team_access_error' => 'Не удалось изменить доступ сотрудника. Попробуйте ещё раз.',
    'team_access_updated' => 'Доступ сотрудника обновлён.',
