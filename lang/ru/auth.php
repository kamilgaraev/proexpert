...
return [
    ...
    'cors' => [
        'origin_forbidden' => 'Источник запроса не разрешён.',
    ],
    ...
    'validation' => [
        ...
        'phone_invalid' => 'Укажите телефон в формате +7XXXXXXXXXX или 8XXXXXXXXXX.',
        ...
        'organization_legal_name_min' => 'Юридическое название должно содержать не менее 2 символов.',
        'organization_tax_number_invalid' => 'ИНН должен содержать 10 цифр для организации или 12 цифр для ИП.',
        'organization_registration_number_invalid' => 'ОГРН должен содержать 13 цифр для организации или 15 цифр для ИП.',
        'organization_email_invalid' => 'Укажите корректный email организации.',
        'organization_address_min' => 'Адрес должен содержать не менее 10 символов.',
        'organization_address_max' => 'Адрес не должен превышать 500 символов.',
        'organization_city_min' => 'Название города должно содержать не менее 2 символов.',
        'organization_city_invalid' => 'Название города может содержать только буквы, пробелы, дефисы и точки.',
        'organization_postal_code_invalid' => 'Почтовый индекс должен содержать ровно 6 цифр.',
        'organization_country_min' => 'Название страны должно содержать не менее 2 символов.',
