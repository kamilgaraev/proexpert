...
return [
    ...
    'structure_locked' => 'Утверждённая смета защищена от изменений. Создайте новую версию, чтобы изменить её состав.',
    ...
    'restore_operation_queued' => 'Восстановление версии запланировано. Можно закрыть страницу — работа продолжится.',
    'restore_operation_processing' => 'Восстанавливаем версию сметы. Можно закрыть страницу — работа продолжится.',
    'restore_operation_completed' => 'Версия восстановлена. Предыдущее состояние сохранено в истории.',
    'restore_operation_failed' => 'Не удалось восстановить версию. Текущая смета сохранена. Повторите попытку.',
    'restore_conflict' => 'Со сметой уже выполняется операция. Дождитесь завершения и обновите страницу.',
    'restore_queue_unavailable' => 'Не удалось запустить восстановление. Повторите попытку немного позже.',
    'revision_operation_queued' => 'Создание редакции запланировано. Можно закрыть страницу — работа продолжится.',
    'revision_operation_processing' => 'Создаём редакцию сметы. Можно закрыть страницу — работа продолжится.',
    'revision_operation_completed' => 'Новая редакция сметы создана.',
    'revision_operation_failed' => 'Не удалось создать редакцию. Исходная смета сохранена. Попробуйте создать редакцию ещё раз.',
    'revision_already_pending' => 'Редакция этой сметы уже создаётся. Дождитесь завершения.',
    'revision_conflict' => 'Создание редакции уже запущено или смета больше не утверждена. Обновите страницу и проверьте её состояние.',
    'revision_queue_unavailable' => 'Не удалось запустить создание редакции. Повторите попытку немного позже.',
    ...
    'import_detection_interrupted' => 'Подготовка сметы прервана по времени обработки. Повторите загрузку. Если ошибка повторится, обратитесь в поддержку.',
    ...
    'import_failed' => 'Не удалось импортировать смету. Повторите попытку. Если ошибка повторится, обратитесь в поддержку.',
    'import_save_failed' => 'Не удалось сохранить смету. Повторите импорт. Если ошибка повторится, обратитесь в поддержку.',
