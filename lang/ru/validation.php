...
return [
    ...
    'attributes' => [
        ...
        'local_display_name' => 'название локальной записи',
        ...
        'confidence_score' => 'уверенность сопоставления',
        'duplicate_warning' => 'признак дубля',
        'safe_payload_preview' => 'безопасное описание данных',
    ],
];
