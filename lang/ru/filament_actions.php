...
return [
    ...
    'delete' => [
        ...
        'knowledge_article' => [
            'heading' => 'Удалить статью базы знаний',
            'description' => 'Статья будет удалена из базы знаний. Перед удалением убедитесь, что на нее не ссылаются подсказки, инструкции и пользовательские сценарии.',
        ],
        'category' => [
