...
return [
    ...
    'ocr' => [
        ...
        'max_spreadsheet_render_cells' => 400,
        'max_spreadsheet_zip_entries' => 2_048,
        'max_spreadsheet_uncompressed_bytes' => 20 * 1024 * 1024,
        'max_spreadsheet_zip_entry_bytes' => 5 * 1024 * 1024,
        'max_spreadsheet_compression_ratio' => 100,
        'max_spreadsheet_merges' => 20_000,
        ...
        'geometry' => [
            ...
            'max_preview_page_bytes' => (int) env('ESTIMATE_GENERATION_PDF_GEOMETRY_MAX_PREVIEW_PAGE_BYTES', 20_000_000),
            'max_preview_page_pixels' => (int) env('ESTIMATE_GENERATION_PDF_GEOMETRY_MAX_PREVIEW_PAGE_PIXELS', 25_000_000),
            'max_preview_total_bytes' => (int) env('ESTIMATE_GENERATION_PDF_GEOMETRY_MAX_PREVIEW_TOTAL_BYTES', 100_000_000),
            'max_preview_total_pixels' => (int) env('ESTIMATE_GENERATION_PDF_GEOMETRY_MAX_PREVIEW_TOTAL_PIXELS', 100_000_000),
        ],
    ...
    'generation' => [
        ...
        'document_cost_limit_rub' => (string) env('ESTIMATE_GENERATION_DOCUMENT_COST_LIMIT_RUB', '600.00'),
        'session_cost_limit_rub' => (string) env('ESTIMATE_GENERATION_SESSION_COST_LIMIT_RUB', '900.00'),
        'document_cost_confirmation_increment_rub' => (string) env(
            'ESTIMATE_GENERATION_DOCUMENT_COST_CONFIRMATION_INCREMENT_RUB',
            '300.00',
        ),
        'session_cost_confirmation_increment_rub' => (string) env(
            'ESTIMATE_GENERATION_SESSION_COST_CONFIRMATION_INCREMENT_RUB',
            '450.00',
        ),
    ],
    'ai_budget' => [
