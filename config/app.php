...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Дополнительные параметры настройки приложения
    |
    */

    // Безопасный режим для доступа к лендингу - временно разрешает доступ всем аутентифицированным пользователям
    'landing_safety_mode' => env('LANDING_SAFETY_MODE', true),
    ...
    |--------------------------------------------------------------------------
    |
    | Domain used for multi-organization subdomains
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | URL фронтенд приложения для генерации ссылок в email уведомлениях
    |
    */
