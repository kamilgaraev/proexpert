...
final class R15CiRuntimeFixtureFactory
{
    ...
    public function build(): array
    {
        ...
        $drillPayload = [ProcurementCycleReportAdapter::AUDIT_DRILL_COLUMN => 'request_created'];
        ...
        $sourceHash = new Sha256Hash(hash('sha256', \App\BusinessModules\Core\Reporting\Support\CanonicalJson::encode([
            'query_hash' => $query->queryHash->value,
            'row_payload_hashes' => [$row->payloadHash->value],
            'drill_payload_hashes' => [$drill->payloadHash->value],
        ])));
        ...
        return compact('candidate', 'binding', 'context', 'query', 'fixture', 'drillCell', 'drillResult', 'write');
    }
}
