...
final class ReportDefinitionBuilder
{
    ...
    private string $sourceModule = 'reports';

    private ReportCoreAccessMode $coreAccessMode = ReportCoreAccessMode::REPORTING_WORKSPACE;
    ...
    public function sorts(array $value): self
    {
        $this->sorts = $value;
    ...
    public function permissionPolicy(ReportPermissionPolicy $value): self
    {
    ...
    public function snapshotClassification(ReportSnapshotClassification $value): self
    {
        $this->snapshotClassification = $value;

        return $this;
    }

    public function outputClassification(ReportOutputClassification $value): self
    {
        $this->outputClassification = $value;

        return $this;
    }

    public function publicationReadiness(ReportPublicationReadiness $value): self
    {
        $this->publicationReadiness = $value;

        return $this;
    }

    public function supportsSubscriptions(bool $value): self
    {
        $this->supportsSubscriptions = $value;

        return $this;
    }

    public function sourceModule(string $value): self
    {
    ...
    public function coreAccessMode(ReportCoreAccessMode $value): self
    {
        $this->coreAccessMode = $value;
    ...
    {
        return new ReportDefinition($this->code, $this->definitionHash, $this->contractVersion, $this->formulaVersion, $this->sourceSchemaVersion, $this->rendererVersion, $this->filters, $this->columns, $this->sorts, $this->formats, $this->permissionPolicy, $this->snapshotClassification, $this->outputClassification, $this->publicationReadiness, $this->supportsSubscriptions, $this->sourceModule, $this->coreAccessMode);
    }
