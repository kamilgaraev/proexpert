...
try {
    ...
    $proposal = app(ContractProposalService::class)->decide($actor, (int) $actor->current_organization_id, (int) $argv[2], (int) $argv[3], 1, 'accepted', '', 'race-'.$argv[3]);
    $result = ['success' => true, 'revision_id' => $proposal['accepted_revision_id']];
