...
final class PlanOneBPlanOneAHandoffTest extends TestCase
{
    public function test_plan_one_a_execution_phase_handoff_is_closed_and_forward_only(): void
    {
        ...
        self::assertSame('historical_red', $contract['task_4f']['state']);
        self::assertSame(13, count($contract['task_4f']['tracked_paths']));
        self::assertSame('370943e3d9a7941589b975472e2ff05c96f3bc63', $contract['task_4g']['commit_sha']);
        self::assertSame('historical_red', $contract['task_4g']['state']);
        self::assertSame(14, count($contract['task_4g']['tracked_paths']));
    ...
    public function test_imported_plan_one_a_constructors_remain_exact(): void
    {
        $constructors = [
            ...
            ReportCursor::class => ['token:string', 'runId:string', 'queryHash:App\\BusinessModules\\Core\\Reporting\\Domain\\ValueObjects\\Sha256Hash', 'sourceHash:App\\BusinessModules\\Core\\Reporting\\Domain\\ValueObjects\\Sha256Hash', 'sort:App\\BusinessModules\\Core\\Reporting\\Domain\\DTO\\ReportWindowSort', 'keyset:App\\BusinessModules\\Core\\Reporting\\Domain\\DTO\\ReportCursorKeyset', 'expiresAt:DateTimeImmutable'],
    ...
    public function test_imported_provider_ports_remain_exact(): void
    {
        ...
        $this->assertMethod(ReportDrillDownProvider::class, 'drillDown', ['context:App\\BusinessModules\\Core\\Reporting\\Domain\\DTO\\ReportExecutionContext', 'snapshot:App\\BusinessModules\\Core\\Reporting\\Domain\\DTO\\ReportSnapshotRef', 'input:App\\BusinessModules\\Core\\Reporting\\Domain\\DTO\\ReportDrillDownInput'], 'App\\BusinessModules\\Core\\Reporting\\Domain\\DTO\\ReportDrillDownResult');
    }
