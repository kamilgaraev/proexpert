...
final class ContractLibraryApiTest extends TestCase
{
    ...
    public function test_registered_routes_keep_separate_permissions(): void
    {
        $expected = [
            ...
            ['GET', 'api/v1/admin/contract-library/{item}/versions/{version}/resolved', 'contracts.library.view'],
            ['POST', 'api/v1/admin/contract-library/{item}/versions/{version}/publish', 'contracts.library.publish'],
            ['PATCH', 'api/v1/admin/contract-library/{item}/archive', 'contracts.library.archive'],
