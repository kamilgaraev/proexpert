...
final class ContractLibraryApiTest extends TestCase
{
    ...
    public function test_registered_routes_keep_separate_permissions(): void
    {
        $expected = [
            ...
            ['GET', 'api/v1/admin/contract-library/{libraryItem}/versions/{version}/resolved', 'contracts.library.view'],
            ['POST', 'api/v1/admin/contract-library/{libraryItem}/versions/{version}/publish', 'contracts.library.publish'],
