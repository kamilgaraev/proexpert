...
final class ReportingAuthorizationMatrixTest extends TestCase
{
    ...
    public static function cases(): iterable
    {
        ...
        yield ['module_disabled_catalog_denied', 1, [403], [null], 0, 0, 6];
        yield ['missing_global_permission_catalog_denied', 1, [403], [null], 0, 0, 6];
        ...
        yield ['view_actor_run_create_denied', 1, [403], [null], 0, 0, 6];
        yield ['view_actor_export_create_denied', 1, [403], [null], 0, 0, 6];
        yield ['view_actor_download_denied', 1, [403], [null], 0, 0, 6];
        ...
        yield ['runner_export_denied', 1, [403], [null], 0, 0, 6];
        yield ['exporter_export_allowed', 1, [201], [null], 1, 1, 6];
        yield ['exporter_download_denied', 1, [403], [null], 0, 0, 6];
        yield ['downloader_revoked_definition_denied', 1, [403], ['REPORT_SCOPE_FORBIDDEN'], 0, 1, 6];
        yield ['manage_does_not_expand_operational_permissions', 3, [403, 403, 403], [null, null, null], 0, 0, 6];
