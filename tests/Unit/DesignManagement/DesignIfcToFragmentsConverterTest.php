...
final class DesignIfcToFragmentsConverterTest extends TestCase
{
    public function test_converter_returns_geometry_metrics_emitted_by_process(): void
    {
        ...
        $this->assertSame('ifc_properties_geometry_v2', $metadata['profile']);
        ...
        $this->assertSame(1, $metadata['ifc_metadata']['indexed_element_count']);
        $this->assertSame([1, 0, 0, 0], array_slice($metadata['ifc_metadata']['coordination_matrix'], 0, 4));
    }
