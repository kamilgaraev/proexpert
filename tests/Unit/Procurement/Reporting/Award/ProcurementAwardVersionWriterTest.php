...
{
    public function test_proposal_version_payload_uses_decimal_strings_stable_line_order_and_no_private_text(): void
    {
        ...
        self::assertArrayNotHasKey('comment', $payload['lines'][0]);
        self::assertArrayNotHasKey('payment_terms', $payload);
        self::assertArrayNotHasKey('delivery_terms', $payload);
    ...
    public function test_request_version_payload_has_stable_decimal_line_snapshot_and_hash(): void
    {
        ...
        self::assertArrayNotHasKey('comment', $payload['request_snapshot']);
        self::assertArrayNotHasKey('metadata', $payload['request_snapshot']);
