...
class NormativeSemanticCompatibilityServiceTest extends TestCase
{
    ...
    public function test_generic_residential_facade_rejects_unconfirmed_material_systems(): void
    {
        ...
        foreach ([
            ...
            'Фактурная отделка фасадов стеклянной крошкой',
            'Устройство системы навесного вентилируемого фасада с облицовкой плитками из мраморной крошки',
            'Устройство вентилируемых фасадов с вертикально-горизонтальным каркасом, с лесов: установка направляющих профилей плоских поверхностей фасада',
            'Облицовка изделиями бетонными декоративно-облицовочными по направляющим профилям для плоских поверхностей фасада',
            'Наружная облицовка по бетонной поверхности фасадными керамическими цветными плитками типа кабанчик',
            'Высококачественная штукатурка фасадов терразитовым раствором',
