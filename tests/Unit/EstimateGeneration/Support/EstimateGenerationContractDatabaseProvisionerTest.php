...
final class EstimateGenerationContractDatabaseProvisionerTest extends TestCase
{
    ...
    public function complete_inventory_registers_every_module_migration_once_and_in_order(): void
    {
        ...
        self::assertStringEndsWith('/2026_08_01_000250_bind_project_model_evidence_to_exact_candidate.php',
            EstimateGenerationContractDatabaseProvisioner::subjectMigration('project-model', '2026_08_01_000250_bind_project_model_evidence_to_exact_candidate.php', $root));
