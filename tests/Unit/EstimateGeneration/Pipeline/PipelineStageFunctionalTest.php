...
final class PipelineStageFunctionalTest extends TestCase
{
    ...
    public function nine_real_stage_boundaries_consume_exact_typed_dependencies(): void
    {
        ...
        $stages = [
            ...
            new PlanWorkItemsStage(new PackagePlannerService, new EstimateDecompositionService, new NormativeWorkItemPlannerService(new ProjectDocumentNormativeReferenceExtractor, new EstimatorScopeInferenceService), new NormativeContextPinResolver, $results, new \App\BusinessModules\Addons\EstimateGeneration\Evidence\InMemoryEvidenceRepository),
