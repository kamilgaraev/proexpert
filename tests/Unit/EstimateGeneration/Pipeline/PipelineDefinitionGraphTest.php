...
final class PipelineDefinitionGraphTest extends TestCase
{
    ...
    public function graph_has_exact_topological_dependencies_and_bounded_total(): void
    {
        ...
        self::assertSame(83, $graph->get(ProcessingStage::PlanWorkItems)->schemaVersion);
        ...
        self::assertLessThanOrEqual(
            ...
            array_sum(array_map(static fn ($definition): int => $definition->maxArtifactBytes, $graph->ordered())),
        );
    }
