...
{
    #[Test]
    public function production_provider_bindings_never_bypass_settings_or_pricing_in_tests(): void
    {
        ...
        self::assertStringContainsString('AiPriceSnapshotResolver::class', $provider);
    }
}
