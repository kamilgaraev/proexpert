...
class AIAssistantSourceEncodingTest extends TestCase
{
    ...
    public static function criticalSourceProvider(): array
    {
        return [
            ...
            'timeweb llm provider' => ['app/BusinessModules/Features/AIAssistant/Services/LLM/TimewebProvider.php'],
            'openai-compatible rag embedding provider' => ['app/BusinessModules/Features/AIAssistant/Services/Rag/OpenAIRagEmbeddingProvider.php'],
