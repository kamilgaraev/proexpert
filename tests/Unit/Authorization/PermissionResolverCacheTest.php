...
final class PermissionResolverCacheTest extends TestCase
{
    ...
    public function test_role_permission_cache_clear_forgets_role_keys_and_bumps_user_versions(): void
    {
        ...
        Cache::put('system_perms_v4_r7_custom_snabzenie_75', ['admin.access'], 3600);
        Cache::put('module_perms_v4_r7_custom_snabzenie_75', ['catalog_management' => ['materials.view']], 3600);
        ...
        $this->assertNull(Cache::get('system_perms_v4_r7_custom_snabzenie_75'));
        $this->assertNull(Cache::get('module_perms_v4_r7_custom_snabzenie_75'));
