...
Реализация расширенного функционала административного дашборда МОСТ с упором на финансовую аналитику, предиктивные возможности, кастомизацию и производительность. Проект разбит на 5 фаз с общей оценкой 8-10 недель разработки.
