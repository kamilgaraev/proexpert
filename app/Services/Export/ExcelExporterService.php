...
class ExcelExporterService
{
    ...
    public function streamDownload(
        ...
        try {
            ...
            return \App\Http\Responses\AdminResponse::fromPayload([
                'error' => trans_message('errors.excel_export_failed'),
            ], 500);
        }
    }
        ...
        try {
            $response = new StreamedResponse(function () use ($foremanData, $materialLogs, $completedWorks) {
                try {
                    ...
                    echo json_encode(['error' => trans_message('errors.report_create_failed')]);
                }
            });
            ...
            return \App\Http\Responses\AdminResponse::fromPayload(['error' => trans_message('errors.report_export_failed')], 500);
        }
    }
    ...
    public function generateOfficialMaterialReport(array $reportData, string $filename)
    {
        ...
        try {
            ...
            return \App\Http\Responses\AdminResponse::fromPayload(['error' => trans_message('errors.file_corrupted')], 500);
        }
    }
