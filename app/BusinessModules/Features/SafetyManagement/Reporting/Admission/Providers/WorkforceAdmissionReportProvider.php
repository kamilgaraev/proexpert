...
{
    public function __construct(private WorkforceAdmissionSnapshotMaterializer $materializer) {}
    ...
    public function result(ReportExecutionContext $context, ReportSnapshotRef $snapshot): ReportResult
    {
        ...
        return new ReportResult(
            ...
            array_map(
                ...
                ['row_key', 'snapshot_date', 'project_id', 'safety_site_id', 'employee_id', 'requirement_code', 'requirement_type', 'status', 'blocked', 'verified', 'valid_until', 'evidence_id', 'medical_details'],
            ),
