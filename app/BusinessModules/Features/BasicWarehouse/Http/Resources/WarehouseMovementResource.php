    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            'cell' => $this->cell ? [
                ...
                'code' => $this->cell->code,
                'name' => $this->cell->name,
                'full_address' => $this->cell->full_address,
                'zone' => $this->cell->zone ? [
                    'id' => $this->cell->zone->id,
                    'code' => $this->cell->zone->code,
                    'name' => $this->cell->zone->name,
                ] : null,
            ] : null,
            'storage_address' => $this->cell?->full_address ?? $this->metadata['storage_address'] ?? null,
