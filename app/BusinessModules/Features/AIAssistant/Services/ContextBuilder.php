...
class ContextBuilder
{
    ...
    public function buildSystemPrompt(): string
    {
        return "Ты - помощник по строительным проектам. Общайся как живой человек, коллега по работе.\n\n" .
               ...
               "ОБЯЗАТЕЛЬНО покажи ссылку в markdown формате!\n" .
               "Формат: [Скачать отчет](https://полная-ссылка-из-контекста)\n" .
               "Пример: 'Готово! [Скачать PDF](https://storage.yandexcloud.net/...)'\n\n" .
