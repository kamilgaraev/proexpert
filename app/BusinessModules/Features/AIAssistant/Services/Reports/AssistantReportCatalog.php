    ...
    public function all(): array
    {
        return [
            ...
            $this->operationalReport(
                ...
                aliases: ['отчет по закупкам', 'отчет по снабжению', 'отчет по заявкам на закупку', 'закупки', 'снабжение', 'заявки на закупку', 'потребность в закупках'],
                matchTerms: ['закупки', 'закупкам', 'снабжение', 'заявки на закупку', 'закупочные заявки', 'потребность в закупках', 'заявки снабжения']
            ),
            $this->operationalReport(
                id: 'purchase_orders',
                capability: 'procurement',
