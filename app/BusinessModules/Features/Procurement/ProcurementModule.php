...
class ProcurementModule implements ModuleInterface, BillableInterface, ConfigurableInterface
{
    ...
    public function getPermissions(): array
    {
        return [
            ...
            'procurement.purchase_requests.reject',
            'procurement.supplier_requests.view',
            'procurement.supplier_requests.create',
            'procurement.supplier_requests.send',
            'procurement.supplier_requests.cancel',
