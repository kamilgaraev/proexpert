                ...
                if ($manager) {
                    $notificationService->send(
                        ...
                        [
                            ...
                            'type' => 'procurement.purchase_request.created',
                            'category' => 'procurement',
                            'interface' => 'admin',
                            'request_id' => $request->id,
                            'request_number' => $request->request_number,
                            'site_request_id' => $request->site_request_id,
                            'project_id' => $request->siteRequest?->project_id,
                            'entity' => ['type' => 'purchase_request', 'id' => $request->id],
                            'target_route' => "/procurement/purchase-requests/{$request->id}",
                        ],
                        'procurement',
                        'normal',
                        null,
            ...
            if ($request->siteRequest && $request->siteRequest->user) {
                ...
                $notificationService->send(
                    ...
                    [
                        ...
                        'type' => 'procurement.purchase_request.approved',
                        'category' => 'procurement',
                        'interface' => 'admin',
                        'request_id' => $request->id,
                        'request_number' => $request->request_number,
                ...
                if ($manager) {
                    $notificationService->send(
                        ...
                        [
                            ...
                            'type' => 'procurement.purchase_order.sent',
                            'category' => 'procurement',
                            'interface' => 'admin',
                            'order_id' => $order->id,
                            ...
                            'entity' => ['type' => 'purchase_order', 'id' => $order->id],
                            'target_route' => "/procurement/purchase-orders/{$order->id}",
                        ],
                        'procurement',
                        'normal',
                        null,
