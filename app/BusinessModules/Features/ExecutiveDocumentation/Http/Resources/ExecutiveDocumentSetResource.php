    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'transmittal' => $this->whenLoaded('transmittal', fn () => $this->transmittal ? [
                ...
                'manifest' => $this->transmittal->manifest,
                'manifest_hash' => $this->transmittal->manifest_hash,
                'status' => $this->transmittal->status,
                'previous_transmittal_id' => $this->transmittal->previous_transmittal_id,
                'decision_at' => $this->transmittal->decision_at?->toIso8601String(),
                'decision_comment' => $this->transmittal->decision_comment,
