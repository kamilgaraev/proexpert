...
final class ChangeRequestResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'monetary_context' => [
                'currency' => $change->reporting_currency,
                'contract_project_allocation_id' => $change->reporting_contract_project_allocation_id,
                'contingency_opening_minor' => $change->contingency_opening_minor,
                'contingency_allocation_minor' => $change->contingency_allocation_minor,
                'contingency_release_minor' => $change->contingency_release_minor,
            ],
            ...
            'customer_approval' => $customerApproval ? [
                ...
                'approved_cost_minor' => $customerApproval->approved_cost_minor,
                'currency' => $customerApproval->currency,
