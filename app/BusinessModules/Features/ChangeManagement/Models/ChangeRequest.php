...
final class ChangeRequest extends Model
{
    ...
    protected $casts = [
        ...
        'reporting_contract_project_allocation_id' => 'integer',
        'contingency_opening_minor' => 'integer',
        'contingency_allocation_minor' => 'integer',
        'contingency_release_minor' => 'integer',
