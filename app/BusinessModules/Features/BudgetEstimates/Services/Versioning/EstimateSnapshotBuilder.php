...
class EstimateSnapshotBuilder
{
    ...
    private function itemPayload(EstimateItem $item, Collection $itemsByParent, array $sectionKeys): array
    {
        ...
        $payload = [
            ...
            'labor_hours' => $this->quantity($item->labor_hours),
            'machinery_hours' => $this->quantity($item->machinery_hours),
            ...
            'materials_index' => $this->quantity($item->materials_index),
            'machinery_index' => $this->quantity($item->machinery_index),
            'labor_index' => $this->quantity($item->labor_index),
