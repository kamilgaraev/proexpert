...
class SmartMappingService
{
    private array $columnKeywords = [
        ...
        'current_total_amount' => [
            ...
            'общая стоимость, руб.', 'сметная стоимость в текущем уровне цен, руб. всего',
            'в текущем уровне цен, руб. всего', 'стоимость всего'
        ],
        'unit_price' => [
            'сметная стоимость', 'цена', 'стоимость', 'цена за ед', 'стоимость единицы',
            'стоимость единицы, руб.', 'цена за единицу', 'сметная стоимость в текущем уровне цен, руб. на единицу',
            'в текущем уровне цен, руб. на единицу'
        ],
        'code' => [
