...
class ExcelSimpleTableParser implements EstimateImportParserInterface
{
    private array $columnKeywords = [
        ...
        'unit_price' => [
            'текущем уровне цен',  // ← ПРИОРИТЕТ: "на единицу измерения в текущем уровне цен" (колонка N)
            'базисном уровне цен', // ← "на единицу измерения в базисном уровне цен" (колонка L)
            'цена', 
            'стоимость', 
            'расценка', 
            'цена за ед', 
            ...
            'текущих ценах',
            'базисных ценах'
            // НЕ добавляем "на единицу", "единицу измерения" - они слишком общие!
        ],
        'code' => [
            'код', 
            'шифр', 
