...
class ContractManagementModule implements ConfigurableInterface, ModuleInterface
{
    ...
    public function getPermissions(): array
    {
        return [
            ...
            'contracts.archive',
            'contracts.trash',
            'contracts.library.view',
            'contracts.library.create',
            'contracts.library.publish',
            'contracts.library.archive',
            'contracts.revisions.accept',
            'contracts.revisions.confirm',
            'contracts.revisions.activate',
            'contracts.revisions.adopt',
            'contracts.revisions.record_external',
            'contracts.analytics',
