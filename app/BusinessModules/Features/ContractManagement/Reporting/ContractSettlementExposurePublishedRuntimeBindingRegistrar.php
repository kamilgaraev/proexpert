...
final readonly class ContractSettlementExposurePublishedRuntimeBindingRegistrar
{
    public function __construct(
        private ReportDefinitionRegistry $definitions,
        private ContractSettlementExposureReportBindingFactory $bindings,
    ) {}

    public function register(ReportDefinitionBindingAssembler $assembler): void
    {
        try {
            $definition = $this->definitions->published(ContractSettlementExposureCandidateContract::CODE);
