...
final readonly class ProjectLaborCostReportBindingFactory
{
    public function __construct(
        private ProjectLaborCostProvider $provider,
        private ProjectLaborCostQueryService $query,
        private ProjectLaborCostCandidateContract $contract,
    ) {}
