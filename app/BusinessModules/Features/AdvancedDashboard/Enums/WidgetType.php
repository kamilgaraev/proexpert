    ...
    public function getMetadata(): array
    {
        return match($this) {
            ...
            self::SYSTEM_METRICS => [
                ...
                'description' => 'Основные метрики производительности системы',
                'icon' => 'server',
                'default_size' => ['w' => 6, 'h' => 3],
                'min_size' => ['w' => 4, 'h' => 2],
            ],
            self::API_PERFORMANCE => [
                'name' => 'Производительность API',
                'description' => 'Метрики производительности API endpoints',
                'icon' => 'zap',
                'default_size' => ['w' => 6, 'h' => 3],
                'min_size' => ['w' => 4, 'h' => 2],
            ],
            self::DATABASE_STATS => [
                'name' => 'Статистика БД',
                'description' => 'Производительность и статистика базы данных',
                'icon' => 'database',
                'default_size' => ['w' => 6, 'h' => 3],
                'min_size' => ['w' => 4, 'h' => 2],
            ],
            self::CACHE_STATS => [
                'name' => 'Статистика кеша',
                'description' => 'Эффективность работы кеширования',
                'icon' => 'layers',
                'default_size' => ['w' => 6, 'h' => 3],
                'min_size' => ['w' => 4, 'h' => 2],
            ],
            self::RESPONSE_TIMES => [
                'name' => 'Время отклика',
                'description' => 'Анализ времени отклика системы',
                'icon' => 'clock',
                'default_size' => ['w' => 12, 'h' => 4],
                'min_size' => ['w' => 6, 'h' => 3],
            ],
