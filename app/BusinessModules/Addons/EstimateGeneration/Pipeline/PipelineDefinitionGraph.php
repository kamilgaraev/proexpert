...
final readonly class PipelineDefinitionGraph
{
    ...
    public static function standard(): self
    {
        return new self([
            ...
            new StageDefinition(ProcessingStage::PlanWorkItems, 7, [ProcessingStage::UnderstandObject, ProcessingStage::ExtractQuantities], 1_310_720),
            new StageDefinition(ProcessingStage::MatchNormatives, 4, [ProcessingStage::PlanWorkItems], 1_310_720),
