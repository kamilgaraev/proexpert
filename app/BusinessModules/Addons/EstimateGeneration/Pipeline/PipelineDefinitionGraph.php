...
final readonly class PipelineDefinitionGraph
{
    ...
    public static function standard(): self
    {
        return new self([
            ...
            new StageDefinition(ProcessingStage::UnderstandObject, 1, [ProcessingStage::UnderstandDocuments], 1_048_576),
            new StageDefinition(ProcessingStage::ExtractQuantities, 1, [ProcessingStage::UnderstandObject], 262_144),
            new StageDefinition(ProcessingStage::PlanWorkItems, 1, [ProcessingStage::UnderstandObject, ProcessingStage::ExtractQuantities], 1_310_720),
            new StageDefinition(ProcessingStage::MatchNormatives, 1, [ProcessingStage::PlanWorkItems], 1_310_720),
