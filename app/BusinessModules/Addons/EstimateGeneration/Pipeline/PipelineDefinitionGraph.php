...
final readonly class PipelineDefinitionGraph
{
    ...
    public static function standard(): self
    {
        return new self([
            ...
            new StageDefinition(ProcessingStage::UnderstandObject, 3, [ProcessingStage::UnderstandDocuments], 1_048_576),
            new StageDefinition(ProcessingStage::ExtractQuantities, 2, [ProcessingStage::UnderstandObject], 262_144),
            new StageDefinition(ProcessingStage::PlanWorkItems, 36, [ProcessingStage::UnderstandObject, ProcessingStage::ExtractQuantities], 1_310_720),
            new StageDefinition(ProcessingStage::MatchNormatives, 15, [ProcessingStage::PlanWorkItems], 1_310_720),
            new StageDefinition(ProcessingStage::AssembleResources, 3, [ProcessingStage::MatchNormatives], 1_048_576),
