...
final readonly class PipelineDefinitionGraph
{
    ...
    public static function standard(): self
    {
        return new self([
            ...
            new StageDefinition(ProcessingStage::PlanWorkItems, 18, [ProcessingStage::UnderstandObject, ProcessingStage::ExtractQuantities], 1_310_720),
            ...
            new StageDefinition(ProcessingStage::ResolvePrices, 2, [ProcessingStage::AssembleResources], 1_441_792),
