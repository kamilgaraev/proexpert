...
SQL);
        ...
        DB::statement("ALTER TABLE estimate_generation_setting_operations ADD CONSTRAINT eg_setting_operation_result_ck CHECK (result IS NULL OR (jsonb_typeof(result) = 'object' AND result ?& ARRAY['snapshot_id','version'] AND (result - ARRAY['snapshot_id','version']) = '{}'::jsonb AND octet_length(result::text) <= 256))");
