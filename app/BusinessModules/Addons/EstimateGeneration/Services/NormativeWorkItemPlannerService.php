...
final class NormativeWorkItemPlannerService
{
    ...
    private function materialScenarioMessage(string $assumptionCode): string
    {
        $fallback = match ($assumptionCode) {
            ...
            'residential_aluminium_or_bimetallic_radiator_sections' => 'Предварительно приняты алюминиевые или биметаллические секционные радиаторы из расчёта 0,10 кВт на 1 м² и 0,18 кВт на секцию. Модель, число секций и тепловую нагрузку нужно уточнить по проекту отопления.',
