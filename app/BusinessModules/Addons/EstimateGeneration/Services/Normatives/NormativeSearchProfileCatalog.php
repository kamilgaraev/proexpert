...
final class NormativeSearchProfileCatalog
{
    ...
    private function baseProfile(string $scope, ?string $action, ?string $system): NormativeSearchProfileData
    {
        if ($scope === 'engineering') {
            return match ($system) {
                ...
                'heating' => $action === 'heating_equipment'
        ...
        return match ($scope) {
            ...
            'finishing' => $this->profile($scope, $action, $system, ['отделк'], ['штукатур', 'окраск', 'плитк', 'стяжк', 'плинтус'], ['15'], ['01', '03', '05', '09', '16', '18', '20', '27', '28'], ['землян', 'шпунт', 'взрыв'], ['plastering', 'baseboard_installation']),
    ...
    private function specificProfile(string $scope, ?string $action, ?string $system): NormativeSearchProfileData
    {
        return match ($action) {
            ...
            'baseboard_installation' => $this->profile($scope, $action, $system, ['плинтус'], ['монтаж', 'галтел', 'отделк'], ['15'], ['01', '03', '05', '09', '16', '18', '20', '27', '28'], ['землян', 'взрыв', 'шпунт'], ['baseboard_installation']),
