...
final class ArbitrationInputBuilder
{
    ...
    {
        $roles = ['observer_literal', 'observer_construction', 'observer_risk'];
        if (array_keys($observerRuns) !== $roles) {
            throw new InvalidArgumentException('arbitration_requires_exactly_three_observers');
        }
        $claims = [];
