...
{
    public function __construct(private EstimateChangeProposalRepository $proposals, private EstimateProposalVersionFence $versions, private EstimateProposalMutationExecutor $executor) {}
