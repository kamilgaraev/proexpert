...
final class ReportExportRecord extends Model
{
    ...
    protected $casts = [
        ...
        'artifact_deletion_lease_expires_at' => 'immutable_datetime',
        'artifact_deletion_attempt_count' => 'integer',
        'artifact_deletion_next_attempt_at' => 'immutable_datetime',
        'artifact_deletion_storage_accepted_at' => 'immutable_datetime',
        'artifact_deleted_at' => 'immutable_datetime',
