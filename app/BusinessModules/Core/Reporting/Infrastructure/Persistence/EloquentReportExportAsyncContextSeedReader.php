...
final readonly class EloquentReportExportAsyncContextSeedReader implements ReportExportAsyncContextSeedReader
{
    ...
    public function forExport(string $exportId): ReportAsyncContextSeed
    {
        try {
            ...
            return new ReportAsyncContextSeed(
                ...
                $scope,
                $definition,
                is_string($record->correlation_lineage_id)
                    ? $record->correlation_lineage_id
                    : null,
            );
    ...
    /** @return list<ReportScopedResource> */
    private function typedResources(mixed $value): array
    {
        ...
        foreach ($value as $item) {
            ...
            $resources[] = new ReportScopedResource(
                $item['kind'],
                $item['id'],
                $item['project_id'],
            );
