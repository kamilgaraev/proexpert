...
final class EloquentReportExportStore implements ReportExportStore, ReportReadyDownloadStore
{
    ...
    private function parentIdentityPairs(ReportExportRecord $record, ReportRunRecord $run): array
    {
        ...
        return [
            ...
            [$record->snapshot_kind, $run->snapshot_kind], [$record->snapshot_id, $run->snapshot_id], [$record->snapshot_materialized_source_hash, $run->snapshot_materialized_source_hash], [$record->snapshot_generated_at, $run->snapshot_generated_at], [$record->snapshot_stale_at, $run->snapshot_stale_at], [$record->snapshot_watermarks, $run->snapshot_watermarks], [$record->snapshot_classification, $run->snapshot_classification],
