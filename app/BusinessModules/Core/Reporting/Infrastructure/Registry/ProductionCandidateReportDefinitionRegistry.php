    ...
    public function __construct()
    {
        ...
        foreach ([
            'quality_defect_flow' => [
                ...
                'columns' => ['row_key', 'project_id', 'contractor_id', 'schedule_task_id', 'quality_defect_id', 'cohort_date', 'severity', 'status', 'opening_flag', 'created_flag', 'reopened_flag', 'closed_flag', 'closing_flag', 'cycle_days', 'due_date', 'evidence_refs'],
            ...
            'safety_incident_actions' => [
                ...
                'columns' => ['row_key', 'project_id', 'safety_site_id', 'contractor_id', 'subject_type', 'subject_id', 'event_date', 'category', 'severity', 'status', 'owner_user_id', 'due_date', 'opening_flag', 'created_flag', 'reopened_flag', 'closed_flag', 'closing_flag', 'evidence_type', 'evidence_id'],
                'sorts' => ['event_date', 'due_date', 'severity', 'status', 'row_key'],
                'sensitive' => [],
                'audit' => ['evidence_type', 'evidence_id'],
            ],
            'workforce_admission' => [
