...
final class ReportingCatalogServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(PortfolioLiquidityBuiltinPublishedReport::class, fn (Application $app): PortfolioLiquidityBuiltinPublishedReport => new PortfolioLiquidityBuiltinPublishedReport(
            $app->make(PortfolioLiquidityCandidateContract::class),
        ));
        $this->app->singleton(ProjectPortfolioHealthCandidateContract::class);
        $this->app->singleton(ProjectPortfolioHealthBuiltinPublishedReport::class, fn (Application $app): ProjectPortfolioHealthBuiltinPublishedReport => new ProjectPortfolioHealthBuiltinPublishedReport($app->make(ProjectPortfolioHealthCandidateContract::class)));
        $this->app->singleton(ProjectEvmControlCandidateContract::class);
        $this->app->singleton(ProjectEvmControlBuiltinPublishedReport::class, fn (Application $app): ProjectEvmControlBuiltinPublishedReport => new ProjectEvmControlBuiltinPublishedReport(
            $app->make(ProjectEvmControlCandidateContract::class),
        ));
        $this->app->singleton(HoldingPerformanceCandidateContract::class);
        $this->app->singleton(
            HoldingPerformanceBuiltinPublishedReport::class,
            fn (Application $app): HoldingPerformanceBuiltinPublishedReport => new HoldingPerformanceBuiltinPublishedReport(
                $app->make(HoldingPerformanceCandidateContract::class),
            ),
        );
        $this->app->singleton(IntercompanyContractFlowCandidateContract::class);
        $this->app->singleton(
            IntercompanyContractFlowBuiltinPublishedReport::class,
            fn (Application $app): IntercompanyContractFlowBuiltinPublishedReport => new IntercompanyContractFlowBuiltinPublishedReport(
                $app->make(IntercompanyContractFlowCandidateContract::class),
            ),
        );
        $this->app->singleton(WipCompletionForecastCandidateContract::class);
        $this->app->singleton(WipCompletionForecastBuiltinPublishedReport::class, fn (Application $app): WipCompletionForecastBuiltinPublishedReport => new WipCompletionForecastBuiltinPublishedReport(
            $app->make(WipCompletionForecastCandidateContract::class),
        ));
        $this->app->singleton(ContractSettlementExposureCandidateContract::class);
        $this->app->singleton(ContractSettlementExposureBuiltinPublishedReport::class, fn (Application $app): ContractSettlementExposureBuiltinPublishedReport => new ContractSettlementExposureBuiltinPublishedReport(
            $app->make(ContractSettlementExposureCandidateContract::class),
        ));
        ...
        $this->app->singleton(AcceptedProductionBuiltinPublishedReport::class, fn (Application $app): AcceptedProductionBuiltinPublishedReport => new AcceptedProductionBuiltinPublishedReport(
            $app->make(AcceptedProductionCandidateContract::class),
        ));
        ...
        $this->app->singleton(
            ...
            fn (Application $app): BuiltinPublishedReportDefinitionRegistry => new BuiltinPublishedReportDefinitionRegistry(
                ...
                $app->make(PortfolioLiquidityBuiltinPublishedReport::class),
                $app->make(ProjectPortfolioHealthBuiltinPublishedReport::class),
                $app->make(ProjectEvmControlBuiltinPublishedReport::class),
                $app->make(WipCompletionForecastBuiltinPublishedReport::class),
                $app->make(ContractSettlementExposureBuiltinPublishedReport::class),
                $app->make(BaselineScheduleVarianceBuiltinPublishedReport::class),
                $app->make(AcceptedProductionBuiltinPublishedReport::class),
                ...
                $app->make(HoldingPerformanceBuiltinPublishedReport::class),
                $app->make(IntercompanyContractFlowBuiltinPublishedReport::class),
                $app->make(LookaheadReadinessBuiltinPublishedReport::class),
                $app->make(ManagementPnlBuiltinPublishedReport::class),
                $app->make(ChangeClaimBuiltinPublishedReport::class),
            ),
        );
        $this->app->singleton(
