...
{
    public function __construct(public string $artifactId, public string $status, public string $releaseSha, public array $gates, public array $sources, public DateTimeImmutable $generatedAt, public array $ownershipCounts = [])
    {
