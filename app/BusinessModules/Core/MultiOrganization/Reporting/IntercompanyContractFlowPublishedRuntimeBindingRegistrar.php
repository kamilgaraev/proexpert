...
final readonly class IntercompanyContractFlowPublishedRuntimeBindingRegistrar
{
    public function __construct(
        private ReportDefinitionRegistry $definitions,
        private IntercompanyContractFlowReportBindingFactory $bindings,
    ) {}

    public function register(ReportDefinitionBindingAssembler $assembler): void
    {
        try {
            $definition = $this->definitions->published(IntercompanyContractFlowCandidateContract::CODE);
