...
final class NavigationGroups
{
    ...
    public const SORT_AI_ESTIMATOR = 80;
    public const SORT_SUPPORT = 90;
    public const SORT_NOTIFICATIONS = 100;
    public const SORT_AUDIT = 110;
    public const SORT_SETTINGS = 120;
    ...
    public static function aiEstimator(): string
    {
        return trans_message('filament_navigation.groups.ai_estimator');
    }
