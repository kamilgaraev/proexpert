...
{
    protected $signature = 'immutable-audit:confirm-drain {--token=}';
    ...
    {
        $rollout->confirmDrain(DB::connection(), (bool) config('legal_archive.audit_phase_b_cutover_enabled', false), (string) $this->option('token'));
