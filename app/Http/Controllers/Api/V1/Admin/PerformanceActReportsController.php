...
class PerformanceActReportsController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('performance_act_reports.index.error', [
    ...
    public function show(int $actId): JsonResponse
    {
        try {
            ...
            Log::error('performance_act_reports.show.error', [
                'act_id' => $actId,
                'message' => $e->getMessage(),
            ]);
    ...
    public function exportPdf(int $actId): JsonResponse
    {
        try {
            ...
            Log::error('performance_act_reports.export_pdf.error', [
                'act_id' => $actId,
                'message' => $e->getMessage(),
            ]);
    ...
    public function exportExcel(int $actId): JsonResponse
    {
        try {
            ...
            Log::error('performance_act_reports.export_excel.error', [
                'act_id' => $actId,
                'message' => $e->getMessage(),
            ]);
    ...
    public function bulkExportExcel(Request $request): JsonResponse
    {
        try {
            ...
            Log::error('performance_act_reports.bulk_export_excel.error', [
                'user_id' => $request->user()?->id,
                'message' => $e->getMessage(),
            ]);
