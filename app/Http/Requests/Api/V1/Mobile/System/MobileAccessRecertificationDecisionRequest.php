...
final class MobileAccessRecertificationDecisionRequest extends FormRequest
{
    ...
    {
        $organizationUser = new ActiveOrganizationUser((int) $this->attributes->get('current_organization_id'));
