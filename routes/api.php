...
Route::post('v1/legal-document-signatures/callback', [\App\Http\Controllers\Api\V1\LegalDocumentSignatureCallbackController::class, 'complete'])
    ->middleware([\App\Http\Middleware\LegalSignatureCallbackBodyLimit::class, 'throttle:legal-signature-callback'])
    ->withoutMiddleware(['throttle:api', \App\Http\Middleware\SetOrganizationContext::class])
    ->name('api.v1.legal-document-signatures.callback');
