...
Документ фиксирует проектную спецификацию PHERP-136: регулярный пересмотр доступов пользователей, ролей и рискованных полномочий в ERP-контуре ProHelper. Это следующая ERP-06 способность после SoD и immutable audit.
