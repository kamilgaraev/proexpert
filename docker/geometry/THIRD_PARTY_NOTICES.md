...
- GNU LibreDWG 0.13.4 — GPL-3.0-or-later. The production image builds the unmodified source from the tagged release and invokes `dwgread` as a separate process. Source: https://github.com/LibreDWG/libredwg/releases/tag/0.13.4. License: https://www.gnu.org/licenses/gpl-3.0.html.
